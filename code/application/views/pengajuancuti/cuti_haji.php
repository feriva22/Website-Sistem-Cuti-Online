...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Pengajuan Cuti Haji/Umroh</h1>
          </div>
          <div class="col-sm-6">
            ...
            <div class="card card-primary">
              ...
              <form role="form" action="<?php echo base_url();?>pengajuancuti/add" method="POST">
                ...
                <div class="form-group">
                    <input type="hidden" class="form-control" id="cti_jenis" name="cti_jenis" value="<?php echo CUTI_HAJI;?>">
                  </div>
                  ...
                  <div class="form-group">
                    <label for="cti_upload">Bukti (surat keterangan pihak travel)</label>
                    <div class="input-group">
                      ...
                      <div class="input-group-append">
                        <span class="input-group-text" val="">Upload</span>
                      </div>
                    </div>
                  </div>
                </div>
