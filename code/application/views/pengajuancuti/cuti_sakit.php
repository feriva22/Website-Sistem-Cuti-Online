...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Pengajuan Cuti Sakit Baru</h1>
          </div>
          <div class="col-sm-6">
              ...
              <form role="form" action="<?php echo base_url();?>pengajuancuti/add" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    <input type="hidden" class="form-control" id="cti_jenis" name="cti_jenis" value="<?php echo CUTI_SAKIT;?>">
                  </div>
                  ...
                  <div class="form-group">
                    <label for="cti_alasan">Sakit yang diderita</label>
                    <input type="text" class="form-control" id="cti_alasan" name="cti_alasan" placeholder="Masukkan Sakit yang diderita">
                  </div>
                  <div class="form-group">
                    <label for="cti_upload">Bukti</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="cti_upload" name="cti_upload">
                        <label class="custom-file-label" for="cti_upload">Choose file</label>
                      </div>
